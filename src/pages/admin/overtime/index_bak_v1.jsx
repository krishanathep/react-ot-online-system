...
const OverTimeAdmin = () => {
  ...
  // Apply filters to all records whenever filters or data changes
  useEffect(() => {
    if (overtimes.length > 0) {
      const filtered = overtimes.filter(record => {
        return (
          (filters.ot_member_id === "" || 
            record.ot_member_id.toLowerCase().includes(filters.ot_member_id.toLowerCase())) &&
          (filters.create_name === "" || 
            record.create_name.toLowerCase().includes(filters.create_name.toLowerCase())) &&
          (filters.department === "" || 
          ...
          (filters.ot_date === null || 
            dayjs(record.ot_date).format('YYYY-MM-DD') === dayjs(filters.ot_date).format('YYYY-MM-DD'))
        );
      });
                      ...
                      columns={[
                        {
                          ...
                          width: 80,
                          render: (record) => records.indexOf(record) + 1 + (page - 1) * pageSize,
                        },
                        {
                          ...
                          filter: (
                            <TextInput
                              ...
                              onChange={(e) => handleFilterChange('ot_member_id', e.currentTarget.value)}
                            />
                          ),
                        },
                        {
                        ...
                        },
                        {
                          ...
                          filter: (
                            <TextInput
                              ...
                              icon={<IconSearch size={16} />}
                              value={filters.dept}
                              onChange={(e) => handleFilterChange('dept', e.currentTarget.value)}
                            />
                          ),
                        },
                        {
                        ...
                        },
                        {
                          ...
                          filter: (
                            <DateInput
                              label="กรองด้วยวันที่ทำ OT"
                              description="เลือกวันที่ทำ OT"
                              placeholder="เลือกวันที่"
                              clearable
                              icon={<IconCalendar size={16} />}
                              value={filters.ot_date}
