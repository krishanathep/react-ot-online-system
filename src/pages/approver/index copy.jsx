...
const Approver = () => {
  ...
  .then((res) => {
    let filteredData = res.data.otrequests;

    if (userDatail().dept === 'PLD' && userDatail().agency === 'PLD_GROUP_1') {
      filteredData = filteredData.filter(
        (item) =>
          item.agency === 'กลุ่มงานวางแผนการผลิต-โรงประกอบ' ||
          item.agency === 'กลุ่มงานวางแผนการผลิต-โรงผลิตชิ้นส่วน'
      );
    }
