  ...
  const getData = async () => {
    ...
    await axios
      ...
      .then((res) => {
        ...
        const filteredData = res.data.data.filter(otrequest => otrequest.department === userDatail().agency && otrequest.result === "ปิดการรายงาน");
          ...
          <div className="container-fluid">
            <div className="row mb-2">
              <div className="col-sm-6">
                <h1 className="m-0">การขออนุมัติ OT</h1>
              </div>
              <div className="col-sm-6">
                      ...
                      columns={[
                        ...
                        },
                        {
                          ...
                          render: (blogs) => (
                            <>
                              <Link
                                to={"/ot-user/overtime/view/" + blogs.id}
